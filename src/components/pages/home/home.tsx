    ...
    return (
        <div className="home">
            <div className="home-container">
                ...
                <h3>What's new ?</h3>
                <p>
                    <span><span><WarningCircle size={24} weight="duotone" color="var(--color-primary)" className="warning-icon" />15/05/2025 </span> - Added the about page content </span>
                    <span><span><WarningCircle size={24} weight="duotone" color="var(--color-primary)" className="warning-icon" />15/05/2025 </span> - Added the translation functionnality (en/fr)</span>
